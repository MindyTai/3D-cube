...
Cube.prototype = {
  ...
  adjustVHSize() {
    ...
    document.getElementsByClassName('box4')[0].style.transform =
      ...
      -(parseInt(this.size, 10) / 2).toString() +
      'px) translateY(' +
      (parseInt(this.size, 10) * 1.5).toString() +
      'px) translateZ(' +
      (parseInt(this.size, 10) / 2).toString() +
      'px) rotateY(-90deg) rotateZ(-270deg)';
  ...
  playSpeed() {
    ...
    document.styleSheets[1].cssRules[6].style.transition =
                ...
                .then(function() {
                  ...
                  return Promise.all(allAssetLoaded$)
                                ...
                                .then(function() {
                                  ...
                                  // return createCube(cubeParam, element);
                                })
